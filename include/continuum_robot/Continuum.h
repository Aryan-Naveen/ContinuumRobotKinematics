...
public:
	...
	Vector6d forwardKinematics(Vector6d theta);
	Vector6d inverseKinematics(Vector6d &thguess, Vector6d &targetOrientation);
	double getIncrement(double val, double incr_scale, double incr_floor);
	void getJacobian(Matrix6d& J, Vector6d& y, Vector6d& r, double incr_scale, double incr_floor);
